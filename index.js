...
app.post("/submit", (req, res) => {
  ...
  var randomNoun = noun[randomNounIndex];

  var randomAdjIndex = Math.floor(Math.random()*noun.length)
  var randomAdj = noun[randomAdjIndex];
  BandName = randomNoun + randomAdj
